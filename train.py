...
def train(dataset):
    ...
    model_gat = oldmodel.GAT(n_cell=dataset.n_cell, n_gene=len(dataset), layers=32, heads=2)
    ...
    for epoch in range(num_epochs):
        for gene_index in range(len(dataset)):
            ...
            count_loss_value = oldmodel.count_loss(tilde_u, tilde_s, u, s)
            ...
            switch_loss_value = oldmodel.switch_loss(model_gat.cp.u0_g3, model_gat.cp.s0_g3, top_u, top_s)
            # switch_loss_value = 0
